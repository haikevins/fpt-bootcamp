# Lab 05 - First-fit Basic

## Mục tiêu

- Cài allocator một free block để hiểu init, alloc, free và exhaustion.
...
```text
build/lab05-first-fit-basic
```

Chạy trực tiếp bằng `./build/lab05-first-fit-basic` hoặc `make run`.
