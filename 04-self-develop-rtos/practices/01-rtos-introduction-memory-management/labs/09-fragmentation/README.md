# Lab 09 - Fragmentation

## Mục tiêu

- Đo internal/external fragmentation và chạy randomized allocator test.
...
```text
build/lab09-fragmentation
```

Chạy trực tiếp bằng `./build/lab09-fragmentation` hoặc `make run`.
