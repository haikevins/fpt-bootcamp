# Lab 03 - Stack High-water Mark

## Mục tiêu

- Dùng fill pattern để ước lượng vùng stack đã sử dụng.
...
```text
build/lab03-stack-high-water
```

Chạy trực tiếp bằng `./build/lab03-stack-high-water` hoặc `make run`.
